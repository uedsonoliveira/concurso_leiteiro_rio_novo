...
const DATA = [
  ...
  { id: "01", nome: "Maravilha", categoria: 40, produtor: "Antônio / Anderson / Kaique", producao: [18.540, 18.870, 18.450, 19.650, 20.470], baia: "Baia: 01", classificada: true },

  { id: "02", nome: "Jurema", categoria: 40, produtor: "Bruno Rohor", producao: [21.530, 17.290, 19.220, 19.960, 20.000], baia: "Baia: 02", classificada: true },

  { id: "03", nome: "Fantasia", categoria: 30, produtor: "Leonardo Blemoek / Gabriel Freitas", producao: [17.050, 15.680, 14.290, 15.040, 19.460], baia: "Baia: 03", classificada: true },

  { id: "04", nome: "Arizona", categoria: 30, produtor: "Lucas Sartori", producao: [14.850, 15.480, 13.910, 17.120, 14.530], baia: "Baia: 04", classificada: true },

  { id: "05", nome: "Rose", categoria: 'Livre', produtor: "Emílio Vieira Paulino", producao: [27.866, 22.200, 25.660, 27.880, 29.590, 24.710, 25.960, 32.120], baia: "Baia: 05", classificada: true },

  { id: "06", nome: "Colombiana", categoria: 'Livre', produtor: "Emílio Vieira Paulino", producao: [19.492, 17.980, 18.360, 20.960, 23.740, 22.800, 21.420, 20.230], baia: "Baia: 06", classificada: true },

  { id: "07", nome: "Heliacea ", categoria: 40, produtor: "Wallace Miranda", producao: [18.604, 18.700, 20.390, 20.830, 20.950], baia: "Baia: 07", classificada: true },

  { id: "08", nome: "Larissa", categoria: 30, produtor: "Leonardo Massolari Bernardo", producao: [15.676, 14.840, 14.510, 15.550, 15.520], baia: "Baia: 08", classificada: true },

  { id: "09", nome: "Paróquia", categoria: 40, produtor: "Tiago Mota de Lima", producao: [19.444, 20.060, 20.230, 19.290, 19.750], baia: "Baia: 09", classificada: true },

  { id: "10", nome: "Pintura", categoria: 40, produtor: "Rogério Ribeiro Araújo", producao: [22.730, 18.020, 20.810, 19.580, 19.210], baia: "Baia: 10", classificada: true },

  { id: "11", nome: "Stefanea", categoria: 30, produtor: "Ulisses Matos", producao: [14.670, 14.060, 14.900, 15.490, 14.580], baia: "Baia: 11", classificada: true },

  { id: "12", nome: "Mamona", categoria: 30, produtor: "Franco Castelione", producao: [12.120, 12.560, 13.460, 16.380, 16.740], baia: "Baia: 12", classificada: true },

  { id: "13", nome: "Manquetinha", categoria: 40, produtor: "Diogo Castelione", producao: [21.540, 16.190, 15.270, 20.400, 25.030], baia: "Baia: 13", classificada: true },

  { id: "14", nome: "Luara", categoria: 40, produtor: "Jhon Rhuon Neves", producao: [19.790, 19.820, 20.950, 20.260, 20.350], baia: "Baia: 14", classificada: true },

  { id: "15", nome: "Roxinha", categoria: 40, produtor: "Waldeir Hemerly", producao: [20.570, 16.970, 17.230, 18.750, 19.970], baia: "Baia: 15", classificada: true },

  { id: "16", nome: "Esperança", categoria: 30, produtor: "Waldeir Hemerly", producao: [16.070, 15.110, 15.540, 13.060, 14.040], baia: "Baia: 16", classificada: true },

  { id: "17", nome: "Estrela", categoria: 30, produtor: "Waldeir Hemerly", producao: [13.936, 16.120, 15.360, 15.760, 15.350], baia: "Baia: 17", classificada: true },

  { id: "18", nome: "Xita", categoria: 30, produtor: "Orlandina Hemerly", producao: [20.234, 9.240, 14.930, 16.500, 12.610], baia: "Baia: 18", classificada: true },

  { id: "19", nome: "Paloma", categoria: 30, produtor: "Rondineli Moreira Pinheiro", producao: [14.240, 13.110, 12.630, 13.510, 13.510], baia: "Baia: 19", classificada: true },

  { id: "20", nome: "Carinhosa", categoria: 30, produtor: "Gilmar Amaro", producao: [14.590, 13.460, 13.300, 13.640, 14.060], baia: "Baia: 20", classificada: true },

  { id: "21", nome: "Donzela", categoria: 40, produtor: "Lindomar M. Pinheiro", producao: [19.654, 19.990, 18.560, 19.890, 21.480], baia: "Baia: 21", classificada: true },

  { id: "22", nome: "Pintada", categoria: 40, produtor: "Balbino Castelari", producao: [18.240, 18.510, 19.500, 20.880, 21.380], baia: "Baia: 22", classificada: true },

  { id: "23", nome: "Serena", categoria: 30, produtor: "Balbino Castelari", producao: [13.960, 16.900, 14.250, 14.610, 15.170], baia: "Baia: 23", classificada: true },

  { id: "24", nome: "Vingadora", categoria: 40, produtor: "Bruno Rohor", producao: [16.602, 17.560, 12.890, 7.490, 10.840], baia: "Baia: 24", classificada: true },

  { id: "25", nome: "Pretinha B.", categoria: 'Livre', produtor: "Edson Michael C. Rohor", producao: [27.176, 22.720, 23.790, 22.360, 29.870, 29.430, 29.720, 30.250], baia: "Baia: 25", classificada: true },

  { id: "26", nome: "Jabaquara", categoria: 40, produtor: "Eralto Rohor", producao: [22.114, 15.720, 22.240, 18.760, 19.510], baia: "Baia: 26", classificada: true },

  { id: "27", nome: "Vanusa", categoria: 30, produtor: "André Oliveira / Lindésio Oliveira", producao: [16.550, 15.900, 16.680, 10.000, 18.920], baia: "Baia: 27", classificada: true },

  { id: "28", nome: "Jamanta", categoria: 40, produtor: "André Oliveira / Lidésio Oliveira", producao: [20.360, 19.420, 20.500, 19.410, 20.410], baia: "Baia: 28", classificada: true },
...
/**
 * ATUALIZADO FINAL: Função principal do ranking com lógica de mapeamento e desempate corretos,
 * garantindo que a propriedade 'rank' seja sempre adicionada.
 */
function rankingPorProximidade(categoria, ordenhaIdx, includeDisqualified) {
  ...
  // ETAPA 1: Processa os dados, calcula totais e desvios padrão
  ...
  // ETAPA 2: Adiciona a diferença do alvo para as categorias relevantes
  const dataWithScore = processedData.map(item => {
    if (categoria !== 'Livre') {
      const alvo = getAlvoDaOrdenha(categoria, ordenhaIdx);
      return { ...item, diferenca: Math.abs(item.total - alvo) };
    }
    return item;
  });

  // ETAPA 3: Ordena os dados com base nos critérios primário e de desempate
  const sortedData = dataWithScore.sort((x, y) => {
    if (categoria === 'Livre') {
      // Critério 1 (Livre): Maior produção total
      const diffTotal = y.total - x.total;
      if (diffTotal !== 0) return diffTotal;
      // Critério 2 (Desempate Livre): Menor desvio padrão
      return x.stdDev - y.stdDev;
    } else {
      // Critério 1 (30/40kg): Menor diferença para o alvo
      const diffDiferenca = x.diferenca - y.diferenca;
      if (diffDiferenca !== 0) return diffDiferenca;
      // Critério 2 (Desempate 30/40kg): Menor desvio padrão
      return x.stdDev - y.stdDev;
    }
  });

  // ETAPA 4: Calcula e atribui os rankings corretos, lidando com empates
  let rank = 1;
  let count = 1; // Contador para saber quantos pular em caso de empate
  let lastScore = -1;

  return sortedData.map((item, index) => {
    const currentScore = (categoria === 'Livre') ? item.total : item.diferenca;
    const currentStdDev = item.stdDev; // Precisamos considerar o desvio no empate

    // Verifica se a pontuação principal E o desvio padrão são diferentes do anterior
    // Usamos uma pequena tolerância para comparar números de ponto flutuante (desvio padrão)
    const tolerance = 0.00001; // Pequena margem para comparação de decimais
    if (Math.abs(currentScore - lastScore) > tolerance || Math.abs(currentStdDev - (sortedData[index - 1]?.stdDev ?? -Infinity)) > tolerance) {
      rank = index + 1;
    }

    lastScore = currentScore;
    return { ...item, rank }; // Adiciona a propriedade 'rank' ao objeto
  });
}
...
function renderMetrica() {
  ...
  CATS.forEach(cat => {
    ...
    const top = rankingPorProximidade(cat, ORDENHA_ATUAL, false)[0];
    if (top) {
...
function renderPremiacao() {
  ...
  if (!container) {
    // Se o elemento não for encontrado, loga um erro e sai para evitar falhas.
    console.error("Elemento 'awards' não encontrado no HTML!");
    return;
  }
  ...
  const premiosPorCategoria = {
    ...
    'Livre': [
      { icon: '🏆', valor: '', titulo: 'Campeã' },
      { icon: '🥈', valor: '', titulo: 'Vice-Campeã' },
      { icon: '🥉', valor: '', titulo: '3º Lugar' },
      { icon: '🎖️', valor: 'R$ 1.000,00', titulo: '4º Lugar' }, // Mantido para estrutura
      { icon: '🏅', valor: 'R$ 500,00', titulo: '5º Lugar' }  // Mantido para estrutura
    ]
  };

  CATS.forEach(cat => {
    // Define quantos serão premiados por categoria
    const topN = (cat === 'Livre') ? 3 : 5;
    const rankingCompleto = rankingPorProximidade(cat, ORDENHA_ATUAL, false);
    // Filtra para mostrar apenas os animais com rank dentro do limite
    const rankingParaPremiar = rankingCompleto.filter(r => r && typeof r.rank === 'number' && r.rank <= topN);

    if (rankingParaPremiar.length > 0) {
      ...
      rankingParaPremiar.forEach(r => {
        // Usa o 'rank' calculado para buscar o prêmio correto no array
        const premio = premiosPorCategoria[cat]?.[r.rank - 1]; // Acesso seguro ao prêmio
        if (premio) {
          bloco.innerHTML += `<div style="display:flex; align-items:center; justify-content:space-between; padding:6px 0; border-bottom:1px solid rgba(255,255,255,.08);"><div style="font-size:2rem;">${premio.icon}</div><div style="flex:1; margin-left:10px;"><strong>${premio.titulo}</strong><br>${r.a.nome} <span style="color:var(--muted); font-size:0.9em;">• ${r.a.baia} • Produtor: ${r.a.produtor}</span></div><div style="font-weight:bold; color:var(--gold);">${premio.valor}</div></div>`;
        }
      });
