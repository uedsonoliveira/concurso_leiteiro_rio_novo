...
const DATA = [
  ...
  { id: "04", nome: "Arizona", categoria: 30, produtor: "Lucas Sartori", producao: [14.850, 15.480, 13.910, 17.120, 14.530, 14.280], baia: "Baia: 04", classificada: true },

  { id: "05", nome: "Rose", categoria: 'Livre', produtor: "Emílio Vieira Paulino", producao: [27.866, 22.200, 25.660, 27.880, 29.590, 24.710, 25.960, 32.120, 0.000], baia: "Baia: 05", classificada: true },

  { id: "06", nome: "Colombiana", categoria: 'Livre', produtor: "Emílio Vieira Paulino", producao: [19.492, 17.980, 18.360, 20.960, 23.740, 22.800, 21.420, 20.230, 0.000], baia: "Baia: 06", classificada: true },

  { id: "07", nome: "Heliacea ", categoria: 40, produtor: "Wallace Miranda", producao: [18.604, 18.700, 20.390, 20.830, 20.950, 20.130], baia: "Baia: 07", classificada: true },

  { id: "08", nome: "Larissa", categoria: 30, produtor: "Leonardo Massolari Bernardo", producao: [15.676, 14.840, 14.510, 15.550, 15.520, 15.280], baia: "Baia: 08", classificada: true },

  { id: "09", nome: "Paróquia", categoria: 40, produtor: "Tiago Mota de Lima", producao: [19.444, 20.060, 20.230, 19.290, 19.750, 20.870], baia: "Baia: 09", classificada: true },

  { id: "10", nome: "Pintura", categoria: 40, produtor: "Rogério Ribeiro Araújo", producao: [22.730, 18.020, 20.810, 19.580, 19.210, 19.340], baia: "Baia: 10", classificada: true },

  { id: "11", nome: "Stefanea", categoria: 30, produtor: "Ulisses Matos", producao: [14.670, 14.060, 14.900, 15.490, 14.580, 15.630], baia: "Baia: 11", classificada: true },

  { id: "12", nome: "Mamona", categoria: 30, produtor: "Franco Castelione", producao: [12.120, 12.560, 13.460, 16.380, 16.740, 19.260], baia: "Baia: 12", classificada: true },

  { id: "13", nome: "Manquetinha", categoria: 40, produtor: "Diogo Castelione", producao: [21.540, 16.190, 15.270, 20.400, 25.030, 24.650], baia: "Baia: 13", classificada: true },

  { id: "14", nome: "Luara", categoria: 40, produtor: "Jhon Rhuon Neves", producao: [19.790, 19.820, 20.950, 20.260, 20.350, 19.530], baia: "Baia: 14", classificada: true },

  { id: "15", nome: "Roxinha", categoria: 40, produtor: "Waldeir Hemerly", producao: [20.570, 16.970, 17.230, 18.750, 19.970, 19.320], baia: "Baia: 15", classificada: true },

  { id: "16", nome: "Esperança", categoria: 30, produtor: "Waldeir Hemerly", producao: [16.070, 15.110, 15.540, 13.060, 14.040, 17.650], baia: "Baia: 16", classificada: true },

  { id: "17", nome: "Estrela", categoria: 30, produtor: "Waldeir Hemerly", producao: [13.936, 16.120, 15.360, 15.760, 15.350, 16.740], baia: "Baia: 17", classificada: true },

  { id: "18", nome: "Xita", categoria: 30, produtor: "Orlandina Hemerly", producao: [20.234, 9.240, 14.930, 16.500, 12.610, 14.910], baia: "Baia: 18", classificada: true },

  { id: "19", nome: "Paloma", categoria: 30, produtor: "Rondineli Moreira Pinheiro", producao: [14.240, 13.110, 12.630, 13.510, 13.510, 13.870], baia: "Baia: 19", classificada: true },

  { id: "20", nome: "Carinhosa", categoria: 30, produtor: "Gilmar Amaro", producao: [14.590, 13.460, 13.300, 13.640, 14.060, 14.170], baia: "Baia: 20", classificada: true },

  { id: "21", nome: "Donzela", categoria: 40, produtor: "Lindomar M. Pinheiro", producao: [19.654, 19.990, 18.560, 19.890, 21.480, 21.180], baia: "Baia: 21", classificada: true },

  { id: "22", nome: "Pintada", categoria: 40, produtor: "Balbino Castelari", producao: [18.240, 18.510, 19.500, 20.880, 21.380, 21.760], baia: "Baia: 22", classificada: true },

  { id: "23", nome: "Serena", categoria: 30, produtor: "Balbino Castelari", producao: [13.960, 16.900, 14.250, 14.610, 15.170, 14.740], baia: "Baia: 23", classificada: true },

  { id: "24", nome: "Vingadora", categoria: 40, produtor: "Bruno Rohor", producao: [16.602, 17.560, 12.890, 7.490, 10.840, 11.040], baia: "Baia: 24", classificada: true },

  { id: "25", nome: "Pretinha B.", categoria: 'Livre', produtor: "Edson Michael C. Rohor", producao: [27.176, 22.720, 23.790, 22.360, 29.870, 29.430, 29.720, 30.250, 0.000], baia: "Baia: 25", classificada: true },

  { id: "26", nome: "Jabaquara", categoria: 40, produtor: "Eralto Rohor", producao: [22.114, 15.720, 22.240, 18.760, 19.510, 21.040], baia: "Baia: 26", classificada: true },

  { id: "27", nome: "Vanusa", categoria: 30, produtor: "André Oliveira / Lindésio Oliveira", producao: [16.550, 15.900, 16.680, 10.000, 18.920, 10.530], baia: "Baia: 27", classificada: true },

  { id: "28", nome: "Jamanta", categoria: 40, produtor: "André Oliveira / Lidésio Oliveira", producao: [20.360, 19.420, 20.500, 19.410, 20.410, 19.510], baia: "Baia: 28", classificada: true },
